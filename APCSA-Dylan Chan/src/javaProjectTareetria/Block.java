...
public class Block implements Locatable, Collidable
{
	...
	public String didCollide(Object obj)
	{
		...
		if (this.getX() + this.getWidth() >= temp.getX()
				&& this.getX() <= temp.getX() + temp.getWidth()
				&& this.getY() + this.getHeight() >= temp.getY()
				&& this.getY() + this.getHeight() <= temp.getY() + temp.getHeight())
		{
			...
			return "BOTTOM";
				...
				&& this.getX() <= temp.getX() + temp.getWidth()
				&& this.getY() <= temp.getY() + temp.getWidth() && this.getY() >= temp.getY())
		{
			System.out.println("TOP");
			return "TOP";
		}

		else if (this.getX() <= temp.getX() + temp.getWidth() && this.getX() >= temp.getX()
				&& this.getY() + this.getHeight() >= temp.getY()
